...
$JBOSS_HOME/bin/$JBOSS_MODE.sh -b 0.0.0.0 --debug -c $JBOSS_CONFIG &

echo "=> Waiting for the server to boot"
wait_for_server

MYSQL_SERVICE_SERVICE_HOST=$DB_PORT_3306_TCP_ADDR
MYSQL_SERVICE_SERVICE_PORT=$DB_PORT_3306_TCP_PORT
...
## echo "=> Install ruxit"
## $JBOSS_HOME/customization/ruxit-Agent-Linux-1.79.168.sh
## echo "=> Install ruxit finished"
...
# Deploy the WAR
cp /opt/jboss/wildfly/target/ProductService.war $JBOSS_HOME/$JBOSS_MODE/deployments/ProductService.war
